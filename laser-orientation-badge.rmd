...
-   I can selected student group with from 70 to 90 in FinalGradeCEMS
...
```{r}
ggplot(d, aes(x = FinalGradeCEMS, y = total_points_earned)) +
  geom_point()
```
...
```{r}
m2 <- lm(FinalGradeCEMS ~ TimeSpent + semester, data = d)
summary(m2)
```
